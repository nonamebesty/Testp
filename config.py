...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001588534838"))
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7312104810:AAEWIGuVLkQNh2fmdPO5bVeudYM4QzMpl8k") 
...
#your channel_id from https://t.me/MissRose_bot by forwarding dummy message to rose and applying command `/id` in reply to that messages
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://filestorebot:filestorebot@filestorebot.vocsels.mongodb.net/?retryWrites=true&w=majority&appName=Filestorebot")
#your database name
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/Demo_Tricks/23")
...
ADMIN_LIST = os.environ.get("ADMINS", "1904146512 1904146512").split()
